...
class Workflow():
    def __init__(self):
        #Initiate graph states and nodes
        workflow = StateGraph(GraphState)
        nodes = Nodes()

        #defines all the graph nodes
        ...
        #give information to writer agent to create draft mail
